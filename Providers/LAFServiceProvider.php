...
{
	/**
	 * Register the LostandFound module service provider.
	 *
	...
	{
		App::register('App\Modules\LAF\Providers\RouteServiceProvider');

		Lang::addNamespace('LAF', realpath(__DIR__.'/../Resources/Lang'));
		View::addNamespace('LAF', base_path('resources/views/vendor/LAF'));
		View::addNamespace('LAF', realpath(__DIR__.'/../Resources/Views'));
	}
